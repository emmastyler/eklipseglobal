            ...
            <div class="nk-blocks d-flex justify-content-center">
                <div class="ath-container m-0">
                    <div class="ath-body">
                        ...
                        <h5 class="ath-heading title">Sign Up<small class="tc-default">Create New EKLIPSE Account</small></h5>
                        <form method="POST" action="{{ route('register') }}" name="form">
                            @csrf
                           
                            @if($errors->any())
                            <div style=" color:white; padding-left: 2px; background-color:tomato; border:1px solid tomato; border-radius:2px; margin-top:5px;">
                            ...
                            <div class="field-item" style="display: block" id="othername">
                                <div class="field-wrap">
                                    <input type="text" class="input-bordered" placeholder="Your Full Name" name="othername" value="">
                                </div>
                            </div>
                            ...
                            <div class="field-item">
                                <div class="field-wrap">
                                    ...
                                    <input id="ref" type="text" class="input-bordered" placeholder="Your username" name="ref" value="{{$ref}}" style="display: none;">
                                </div>
                            </div>
                            <div class="field-item">
                                <div class="field-wrap">
                        ...
                        <div style="display: none" id="niger">
                            <div class="field-item">
                                ...
                                <div class="field-item">
                                <div class="field-wrap">
                                    <input type="text" class="input-bordered" placeholder="Bank Account Number" onchange="process()" name="account_number" :value="old('account_number')">
                                </div>
                            </div>
                            ...
                            <div class="field-item">
                                ...
                                <label for="agree-term-2">I agree to Eklipse <a href="#">Privacy Policy</a> &amp; <a href="#">Terms</a>.</label>
                            </div>
