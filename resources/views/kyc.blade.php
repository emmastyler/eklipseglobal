...
<body class="user-dashboard">
    ...
    @include('layouts.nav')
                <div class="user-content">
                    <div class="user-kyc">
                        <form action="{{route('kycinfo')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="from-step"> 
                                @if($errors->any())
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input class="input-bordered date-picker" type="text" id="date-of-birth" name="dob" required>
                                                </div><!-- .input-item -->
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    <label for="nationality" class="input-item-label">Nationality</label>
                                                    <select class="country-select" name="nationality" id="Nationality" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input class="input-bordered" type="text" id="address-line-1" name="address1" required>
                                                </div><!-- .input-item -->
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    <label for="address-line-2" class="input-item-label">Address Line 2</label>
                                                    <input class="input-bordered" type="text" id="address-line-2" name="address2" required >
                                                </div><!-- .input-item -->
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    <label for="email-address" class="input-item-label">City of Residence</label>
                                                    <input class="input-bordered" type="text" id="email-address" name="city" required>
                                                </div><!-- .input-item -->
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    <label for="phone-number" class="input-item-label">Zip Code</label>
                                                    <input class="input-bordered" type="text" id="phone-number" name="zipcode" required>
                                                </div><!-- .input-item -->
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                {{-- <div class="input-item input-with-label">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="upload-box">
                                                            <div class="upload-zone">
                                                                ...
                                                                <input type="file" name="image[]" multiple id="img_file" onChange="img_pathUrl(this);">
