...
<head>
    ...
    <!-- Bundle and Base CSS -->
    <link rel="stylesheet" href="{{url('assets/css/vendor.bundle.css?ver=200')}}">
    <link rel="stylesheet" href="{{url('assets/css/style-salvia.css?ver=200')}}">
    <!-- Extra CSS -->
    <link rel="stylesheet" href="{{url('assets/css/theme.css?ver=200')}}">
</head>
...
<body class="nk-body body-wider theme-dark mode-onepage">
    ...
    <body class="nk-body body-wider theme-dark mode-onepage">
                        ...
                        <div class="header-wrap">
                            ...
                            <div class="header-logo logo animated" data-animate="fadeInDown" data-delay=".65">
                                <a href="./" class="logo-link">
                                    ...
                                    <h3 style="color: black"><a href="{{url('/')}}" style="">Eclipse</a></h3>
                        ...
                        <div class="nk-block nk-block-footer">
                            <div class="row justify-content-between text-center text-sm-start">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-3">
                                    <div class="wgs wgs-menu">
                                        <h6 class="wgs-title text-white animated" data-animate="fadeInUp" data-delay=".3">Resources</h6>
                                        <div class="wgs-body">
        ...
        <!-- JavaScript -->
        <script src="{{url('assets/js/jquery.bundle.js?ver=200')}}"></script>
        <script src="{{url('assets/js/scripts.js?ver=200')}}"></script>
        <script src="{{url('assets/js/charts.js?ver=200')}}"></script>
        <script src="{{url('assets/js/charts.js?ver=200')}}"></script>
    </body>
